...
Button {
    ...
    Text {
        ...
        horizontalAlignment: (customHAlignment === "Left") ? Text.AlignLeft : (customHAlignment === "Center") ? Text.AlignHCenter: (customHAlignment === "Right") ? Text.AlignRight: (customHAlignment === "Justify") ? Text.AlignJustify: Text.AlignLeft
